...
const cv::Mat VisualPointFeatureVector3DToMatConverter::Convert(const VisualPointFeatureVector3DWrapper::VisualPointFeatureVector3D& featuresVector)
	{
...
void VisualPointFeatureVector3DToMatConverter::Convert(const VisualPointFeatureVector3DWrapper::VisualPointFeatureVector3D& featuresVector, cv::Mat& conversion)
	{
