...
T_Double PointCloud::GetXCoordinate(int pointIndex) const
	{
	ASSERT(pointIndex < pointCloud.points.nCount, "A missing point was requested from a features vector 2D");
 ...
 * --------------------------------------------------------------------------
 */
const T_UInt32 PointCloud::MAX_CLOUD_SIZE = CTypes::maxPointcloudSize;
