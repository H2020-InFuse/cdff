...
#ifndef PCLVISUALIZER_HPP
#define PCLVISUALIZER_HPP
...
{
	/**
	 * A class for displaying point clouds and other PCL data structures
	 */
	class PclVisualizer
	{
		public:
			...
			static void ShowMatches(pcl::PointCloud<pcl::PointXYZ>::ConstPtr pointCloud1, pcl::PointCloud<pcl::PointXYZ>::ConstPtr pointCloud2, const std::vector<int>& indexList1, const std::vector<int>& indexList2);
