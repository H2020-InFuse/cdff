...
const std::string USAGE =
	...
	(iv) the name of the Ransac3D Configuration file \n \
	...
	Example Usage: ./harris_shot_ransac ../tests/ConfigurationFiles/DFNsIntegration/Odometry3D HarrisDetector3d_PerformanceTest_1.yaml ShotDescriptor3d_PerformanceTest_1.yaml \
	Ransac3d_PerformanceTest_1.yaml Harris_Shot_Ransac.txt ../tests/Data/PointClouds/bunny0.ply 0.001 ../tests/Data/PointCloud/Transform.txt ../test/Data/PointCloud/bunnyPart1.ply  \
