 ...
 * @addtogroup DFNsTest
 *
 * Unit Test for the DFN Disparity Image.
 *
 *
 * @{
 */
 ...
 * --------------------------------------------------------------------------
 */
TEST_CASE( "Call to process (Disparity Image)", "[process]" )
{
	...
	// Instantiate DFN
	CDFF::DFN::DisparityImage::DisparityImage *disparityImage = new CDFF::DFN::DisparityImage::DisparityImage();
