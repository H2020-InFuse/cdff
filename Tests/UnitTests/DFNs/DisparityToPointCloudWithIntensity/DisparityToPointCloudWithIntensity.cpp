...
/*!
 * @file DisparityToPointCloudWithIntensity.cpp
 * @date 20/12/2018
 ...
 * @addtogroup DFNsTest
 *
 * Unit Test for the DFN Disparity To PointCloud With Intensity.
 *
 *
 * @{
 */
 ...
 * --------------------------------------------------------------------------
 */
TEST_CASE( "Call to process (Disparity To PointCloud With Intensity)", "[process]" )
{
	...
	// Instantiate DFN
	CDFF::DFN::DisparityToPointCloudWithIntensity::DisparityToPointCloudWithIntensity *disparityToPointCloudWithIntensity = new CDFF::DFN::DisparityToPointCloudWithIntensity::DisparityToPointCloudWithIntensity();

	// Send input data to DFN
	disparityToPointCloudWithIntensity->dispImageInput(*dispImage);
	disparityToPointCloudWithIntensity->intensityImageInput(*intensityImage);

	// Run DFN
	disparityToPointCloudWithIntensity->process();

	// Query output data from DFN
	const asn1SccPointcloud &output = disparityToPointCloudWithIntensity->pointCloudOutput();
	...
	delete (disparityToPointCloudWithIntensity);
}
