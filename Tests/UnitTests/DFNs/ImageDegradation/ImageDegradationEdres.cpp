 ...
 * @addtogroup DFNsTest
 *
 * Unit Test for the DFN ImageDegradationEdres.
 *
 *
 * @{
 */
 ...
 * --------------------------------------------------------------------------
 */
TEST_CASE( "Call to process (ImageDegradationEdres)", "[process]" )
{
    // Prepare input data
    ...
    // Instantiate DFN
    CDFF::DFN::ImageDegradation::ImageDegradationEdres* degradation = new CDFF::DFN::ImageDegradation::ImageDegradationEdres();
