 ...
 * 
 * Testing application for the DFPC EstimationFromStereo.
 * 
 * 
 * @{
 */
...
const std::string CONFIGURATION_FILE_PATH = "../../tests/ConfigurationFiles/DFPCs/Reconstruction3D/DfpcEstimationFromStereo_conf01.yaml";
...
int main(int argc, char** argv)
	...
	guiReconstruction3d.Run(*estimationFromStereo);

	delete(estimationFromStereo);
	return 0;
	};
