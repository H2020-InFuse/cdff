 ...
 * @addtogroup DFNsTest
 * 
 * Position Test 4.1.1.2 for DFN implementation SvdDecomposition.
...
Example Usage: ./position_test_svd ../tests/ConfigurationFiles/DFNs/BundleAdjustment/SvdDecomposition_DevonIsland.yaml \
...
int main(int argc, char** argv)
	...
	PositionTester tester(configurationFilePath, svd);
