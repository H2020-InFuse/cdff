 ...
 * @addtogroup DFNsTest
 *
 * Validity Test 4.1.1.6 for DFN implementation ScanlineOptimization.
...
int main(int argc, char** argv)
	...
	if (mode == "ComputePointCloud")
		{
		ScanlineOptimization* scanline = new ScanlineOptimization();
		return mainComputePointCloudMode(argc, argv, scanline);
		}
