...
Example Usage: ./correct_assembly_test ../tests/ConfigurationFiles/DFNs/PointCloudAssembly/NearestNeighbourAssembly_DlrHcru.yaml ../tests/Data/PointClouds PointCloudList.txt OutputPointCloud.ply \n \n";
