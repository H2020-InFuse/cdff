 ...
 * @addtogroup DFNsTest
 * 
 * Correctness Test for DFNs implementation HarrisDetector3D - ShotDescriptor3D - Ransac3D.
...
Example Usage: ./correctness_harris_shot_ransac ../tests/ConfigurationFiles/DFNs/FeaturesExtractor3D/HarrisDetector3D_DevonIsland.yaml ../tests/ConfigurationFiles/DFNs/FeaturesDescriptor3D/ShotDescriptor3D_DevonIsland.yaml ../tests/ConfigurationFiles/DFNs/FeaturesMatcher3D/Ransac3D_DevonIsland.yaml ../tests/Data/PointClouds/DevonIslandRoad.ply ../tests/Data/PointClouds/DevonIslandRoadTransformed.ply ../tests/Data/PointClouds/DevonIslandRoadTransform.txt 20 \n \n";
...
int main(int argc, char** argv)
	{
	std::string harrisConfigurationFilePath, shotConfigurationFilePath, ransacConfigurationFilePath;
	...
	tester.SetDfns(harris, shot, ransac);
