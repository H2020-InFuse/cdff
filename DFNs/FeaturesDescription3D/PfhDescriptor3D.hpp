...
#ifndef FEATURESDESCRIPTION3D_PFHDESCRIPTOR3D_HPP
#define FEATURESDESCRIPTION3D_PFHDESCRIPTOR3D_HPP
...
{
	/**
	 * Computation of descriptors for input 3D keypoints using PFH (provided
	 * by PCL).
	 *
	 * @param searchRadius
	 ...
	 *        in the computation of the surface normal at the point
	 */
	class PfhDescriptor3D : public FeaturesDescription3DInterface
	{
		public:

			PfhDescriptor3D();
			virtual ~PfhDescriptor3D();
		...
		private:
			...
			PfhOptionsSet parameters;
			static const PfhOptionsSet DEFAULT_PARAMETERS;
			...
			pcl::PointCloud<pcl::PFHSignature125>::ConstPtr ComputePfhDescriptors(
...
#endif // FEATURESDESCRIPTION3D_PfhDescriptor3D_HPP
