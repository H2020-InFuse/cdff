 ...
 * @addtogroup DFNs
 * 
 * KalmanPredictor Implementation .
 * 
 * 
 * @{
 */
...
KalmanPredictor::KalmanPredictor():timeOfLastValidCorrection(-1),KF(12,6,0),Tpred(4,4,CV_32F),Test(4,4,CV_32F)
	{
...
void KalmanPredictor::process() {
	...
	float time0=0; //pose initialization time stamp
	...
	//DFN user should decide when to initialize
	if(time0==0)
