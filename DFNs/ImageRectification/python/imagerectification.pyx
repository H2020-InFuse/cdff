...
cdef class ImageRectification:
    ...
    def __init__(self):
        self.thisptr = new _imagerectification.ImageRectification()
    ...
    def rectifiedImageOutput(self):
        cdef cdff_types.Frame out = cdff_types.Frame()
        out.thisptr[0] = self.thisptr.rectifiedImageOutput()
        return out
...
cdef class ImageRectificationEdres:
    ...
    def __init__(self):
        self.thisptr = new _imagerectification.ImageRectificationEdres()
        self.delete_thisptr = True
