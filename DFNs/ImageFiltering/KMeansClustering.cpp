...
namespace CDFF {
    namespace DFN {
        ...
        KMeansClustering::KMeansClustering() {
            ...
            _parametersHelper.AddParameter<double>("KMeansClustering", "tolerance", _parameters.tolerance, DefaultParameters.tolerance);
        ...
        void KMeansClustering::process() {
            ...
            if (inImage.data.channels == 1) {
                ...
                std::copy(inImage.data.data.arr, inImage.data.data.arr + inImage.data.data.nCount, input_3channel.data);
        ...
        cv::Mat KMeansClustering::ClusterPixels(const cv::Mat &inputImage, const std::vector<float> &kmeans_centroids) {
